...
class ParticleEditor {
  ...
  private pePrevViewportWidth = window.innerWidth;
  private pePrevViewportHeight = window.innerHeight;
  ...
  private repositionPanelsToViewport() {
    ...
    const oldW = this.pePrevViewportWidth;
    const oldH = this.pePrevViewportHeight;
    this.pePrevViewportWidth = newW;
    this.pePrevViewportHeight = newH;
